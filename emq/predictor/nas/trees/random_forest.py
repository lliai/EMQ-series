...
from emq.predictor.nas.trees import BaseTree
from emq.predictor.nas.trees.ngb import loguniform
...
class RandomForestPredictor(BaseTree):
    ...
    def fit(self, xtrain, ytrain, train_info=None, params=None, **kwargs):
        ...
        return super(RandomForestPredictor, self).fit(xtrain, ytrain, params,
                                                      **kwargs)
