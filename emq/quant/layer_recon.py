...
from emq.quant.adaptive_rounding import AdaRoundQuantizer
from emq.quant.block_recon import LinearTempDecay
from emq.quant.data_utils import save_grad_data, save_inp_oup_data
from emq.quant.quant_layer import QuantModule, StraightThrough, lp_loss
    ...
    def __call__(self, pred, tgt, grad=None):
        ...
        if self.count % 500 == 0:
            print(
                ...
                .format(
                    float(total_loss), float(rec_loss), float(round_loss), b,
                    self.count))
        return total_loss
