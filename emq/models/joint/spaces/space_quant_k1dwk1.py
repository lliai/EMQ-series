...
from .mutator.conv_bn_relu_mutator import ConvKXBNRELUMutator
from .mutator.super_quant_res_k1dwk1_mutator import SuperQuantResK1DWK1Mutator
...
class SpaceQuantk1dwk1(CnnBaseSpace):
    ...
    def __init__(self,
        ...
        kwargs = dict(
            ...
            nbits_ratio=0.1,
            mutate_method_list=['out', 'k', 'btn', 'nbits'],
        ...
        self.mutators['ConvKXBNRELU'] = ConvKXBNRELUMutator(**kwargs)
        self.mutators['SuperQuantResK1DWK1'] = SuperQuantResK1DWK1Mutator(
            **kwargs)
