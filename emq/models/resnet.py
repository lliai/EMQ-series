...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.block_list = [self.layer1, self.layer2, self.layer3, self.layer4]
    ...
    def get_stage_info(self):
        ...
        block_num = 0
        layer_num = 0
        for idx, sequen in enumerate(self.block_list):
            for the_block in sequen:
                ...
                channel_num = the_block.outplanes
