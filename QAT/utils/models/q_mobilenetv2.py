...
class Q_LinearBottleneck(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels, stride, expansion,
                 remove_exp_conv):
        """
    ...
    def forward(self, x, scaling_factor_int32=None):
        ...
        x, act_scaling_factor = self.quant_act(x, scaling_factor_int32, None,
                                               None, None, None)

        if self.use_exp_conv:
            x, weight_scaling_factor = self.conv1(x, act_scaling_factor)
            x = self.activatition_func(x)
            x, self.act_scaling_factor = self.quant_act1(
        ...
        if self.residual:
            ...
            x, act_scaling_factor = self.quant_act_int32(
                x, act_scaling_factor, weight_scaling_factor, identity,
                scaling_factor_int32, None)
        else:
            x, act_scaling_factor = self.quant_act_int32(
                x, act_scaling_factor, weight_scaling_factor, None, None, None)
...
class Q_MobileNetV2(nn.Module):
    ...
    def __init__(self,
        ...
        self.init_block.set_param(model.features.init_block.conv,
        ...
        self.features.final_block.set_param(model.features.final_block.conv,
                                            model.features.final_block.bn)
    ...
    def forward(self, x):
        ...
        x = self.activatition_func(x)
        x, act_scaling_factor = self.quant_act_int32(x, act_scaling_factor,
                                                     weight_scaling_factor,
                                                     None, None)
        ...
        x, act_scaling_factor = self.quant_act_before_final_block(
            x, act_scaling_factor, None, None, None, None)
        x, weight_scaling_factor = self.features.final_block(
            x, act_scaling_factor)
        x = self.activatition_func(x)
        x, act_scaling_factor = self.quant_act_int32_final(
            x, act_scaling_factor, weight_scaling_factor, None, None, None)
