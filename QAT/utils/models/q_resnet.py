...
from pytorchcv.models.shufflenetv2 import ShuffleInitBlock, ShuffleUnit
...
class Q_ResNet18(nn.Module):
    ...
    def __init__(self, model):
        ...
        self.quant_init_block_convbn.set_param(init_block.conv.conv,
                                               init_block.conv.bn)
        ...
        for stage_num in range(0, 4):
            ...
            for unit_num in range(0, self.channel[stage_num]):
                ...
                setattr(self, f'stage{stage_num + 1}.unit{unit_num + 1}',
                        quant_unit)
    ...
    def forward(self, x):
        ...
        for stage_num in range(0, 4):
            for unit_num in range(0, self.channel[stage_num]):
                tmp_func = getattr(self,
                                   f'stage{stage_num+1}.unit{unit_num+1}')
...
class Q_ResNet50(nn.Module):
    ...
    def __init__(self, model):
        ...
        self.quant_init_convbn.set_param(init_block.conv.conv,
                                         init_block.conv.bn)
...
class Q_ResUnitBn(nn.Module):
    ...
    def set_param(self, unit):
        ...
        if self.resize_identity:
            ...
            self.quant_identity_convbn.set_param(unit.identity_conv.conv,
                                                 unit.identity_conv.bn)
