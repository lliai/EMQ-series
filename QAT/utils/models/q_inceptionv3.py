...
from ..quantization_utils.quant_modules import *  # noqa: F403,F401
...
class Q_InceptConv(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels, kernel_size, stride,
                 padding):
...
def q_incept_conv1x1(model, in_channels, out_channels):
    """
...
class Q_MaxPoolBranch(nn.Module):
    ...
    def __init__(self):
        ...
        self.q_pool = QuantMaxPool2d(kernel_size=3, stride=2, padding=0)
...
class Q_AvgPoolBranch(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels):
        ...
        self.q_input_act = QuantAct()
        self.q_pool = QuantAveragePool2d(kernel_size=3, stride=1, padding=1)
...
class Q_ConvSeqBranch(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels_list, kernel_size_list,
        ...
        for i, (out_channels, kernel_size, strides, padding) in enumerate(
                zip(out_channels_list, kernel_size_list, strides_list,
                    padding_list)):
            self.q_conv_list.add_module(
                'q_conv{}'.format(i + 1),
                Q_InceptConv(
...
class Q_ConvSeq3x3Branch(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.q_rescaling_activ((x, [scaling_factor1,
                                        scaling_factor2], channel_num))
        return x
...
class Q_InceptionBUnit(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels, mid_channels):
        ...
        self.branches.add_module(
            ...
            Q_ConvSeqBranch(
                model=model.branches.branch3,
                in_channels=in_channels,
                out_channels_list=(mid_channels, mid_channels, mid_channels,
                                   mid_channels, 192),
...
class Q_InceptInitBlock(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels):
        ...
        self.q_conv3 = Q_InceptConv(
            ...
            stride=1,
            padding=1)
        self.q_pool1 = QuantMaxPool2d(kernel_size=3, stride=2, padding=0)
        ...
        self.q_conv5 = Q_InceptConv(
            ...
            stride=1,
            padding=0)
        self.q_pool2 = QuantMaxPool2d(kernel_size=3, stride=2, padding=0)
...
class Q_InceptionV3(nn.Module):
    ...
    def __init__(self,
        ...
        self.features.add_module('q_final_pool',
                                 QuantAveragePool2d(kernel_size=8, stride=1))
